...
if (is_home() || is_front_page() || is_page('Newsletter')){
?>
<div class="caja-newsletter">
	<div class="form-newsletter">
		<?php if ( is_active_sidebar( 'id-newsletter_costura' ) ) : ?> 
			<?php dynamic_sidebar( 'id-newsletter_costura' ); ?>
		<?php endif; ?>
	</div>
</div>
<?php
...
<script type="text/javascript" src="/wp-content/themes/little-bubble/js/slick.min.js"></script>
