 ...
 */
function bubble_layouts_folder( $layout_folders ) {
	$layout_folders[] = get_template_directory() . '/inc/layouts';
	return $layout_folders;
}
add_filter( 'siteorigin_panels_local_layouts_directories', 'bubble_layouts_folder' );

/**
 * Remove Post Loop widget templates that aren't complete loops.
 */
function bubble_filter_post_loop_widget( $templates ) {
...
add_filter( 'siteorigin_panels_postloop_templates', 'bubble_filter_post_loop_widget', 10, 1 );
