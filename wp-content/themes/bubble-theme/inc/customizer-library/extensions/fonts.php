...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'bubble' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'bubble' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'bubble' ),
		'cyrillic'     => __( 'Cyrillic', 'bubble' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'bubble' ),
		'devanagari'   => __( 'Devanagari', 'bubble' ),
		'greek'        => __( 'Greek', 'bubble' ),
		'greek-ext'    => __( 'Greek Extended', 'bubble' ),
		'khmer'        => __( 'Khmer', 'bubble' ),
		'latin'        => __( 'Latin', 'bubble' ),
		'latin-ext'    => __( 'Latin Extended', 'bubble' ),
		'vietnamese'   => __( 'Vietnamese', 'bubble' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'bubble' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'bubble' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'bubble' ),
