...
function bubble_body_classes( $classes ) {
	...
	$page_settings = bubble_page_setting();
...
if ( ! function_exists( 'bubble_unset_current_menu_class' ) ) :
/**
 * Unset the current menu class.
 */
function bubble_unset_current_menu_class( $classes ) {
...
add_filter( 'nav_menu_css_class', 'bubble_unset_current_menu_class', 10, 1 );

if ( ! function_exists( 'bubble_post_class_filter' ) ) :
/**
* Filter post classes.
* @link https://codex.wordpress.org/Function_Reference/post_class.
*/
function bubble_post_class_filter( $classes ) {
	$classes[] = 'post';
...
add_filter( 'post_class', 'bubble_post_class_filter' );
