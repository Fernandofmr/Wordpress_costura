...
if ( ! function_exists( 'bubble_build_styles' ) && class_exists( 'Customizer_Library_Styles' ) ) :
/**
 * Process user options to generate CSS needed to implement the choices.
 *
 * @return void
 */
function bubble_build_styles() {
...
add_action( 'customizer_library_styles', 'bubble_build_styles' );

function bubble_mobile_menu_collapse() {
	...
	if ( is_active_sidebar( 'sidebar-bubble-header' ) ) {
...
add_action( 'customizer_library_styles', 'bubble_mobile_menu_collapse' );

if ( ! function_exists( 'bubble_styles' ) ) :
/**
...
function bubble_styles() {
	...
	if ( ! empty( $css ) ) {
		echo "\n<style type=\"text/css\" id=\"bubble-custom-css\">\n";
		echo $css;
		echo "\n</style>\n";
	}
}
endif;
add_action( 'wp_head', 'bubble_styles', 11 );
